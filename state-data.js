...
const host = "https://www.mygov.in/corona-data/covid19-statewise-status";
...
const covid19StateWiseUpdate = async () => {
    ...
    try {
     ...
     const tnEmergencyContact = $('#node-287111 > div > div.field-collection-container.clearfix > div > div.field-items > div > div > div > div ').map( async (index, element) => {
